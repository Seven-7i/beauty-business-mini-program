...
import CustomerDetailPage from "@/pages-beauty/features/customer/components/CustomerDetailPage.vue";
import {
  openCustomerEditor,
  subscribeCustomerSaved,
  type CustomerSavedPayload,
} from "@/pages-beauty/features/customer/customer-create-navigation";
import {
  completeCustomerDetailDeletion,
  openCustomerAppointmentDetail,
  readCustomerDetailId,
  returnToCustomerList,
} from "@/pages-beauty/features/customer/customer-detail-navigation";
import {
...
<template>
  <view class="customer-detail-route">
    <CustomerDetailPage
      ...
      @open-appointment="openCustomerAppointmentDetail"
    />
