...
} from "@/pages-beauty/features/beauty-project/beauty-project-navigation";
import BeautyProjectEditor from "@/pages-beauty/features/beauty-project/components/BeautyProjectEditor.vue";
import {
...
function openInventory(): void {
  ...
  uni.navigateTo({
    url: `/pages-beauty/inventory-create/index?mode=project-quick-add&requestId=${encodeURIComponent(requestId)}`,
    fail: () => {
