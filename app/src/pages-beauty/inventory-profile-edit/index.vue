...
import InventoryItemProfileEditPage from "@/pages-beauty/features/inventory/components/InventoryItemProfileEditPage.vue";
import {
...
function returnToSource(): void {
  ...
  if (inventoryItemId.value) {
    uni.reLaunch({
      url: `/pages-beauty/inventory-detail/index?inventoryItemId=${encodeURIComponent(
