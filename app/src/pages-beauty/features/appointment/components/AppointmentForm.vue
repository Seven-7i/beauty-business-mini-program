    ...
    <view v-if="!editingAppointment" class="form-card form-card--mode">
      ...
      <view class="segmented-control" role="tablist" aria-label="预约类型">
        <view
          ...
          @keyup.enter="setEntryMode('scheduled')"
          @keyup.space.prevent="setEntryMode('scheduled')"
        >
        ...
        <view
          ...
          @keyup.enter="setEntryMode('backfilled')"
          @keyup.space.prevent="setEntryMode('backfilled')"
        >
    ...
    <view v-if="form.entryMode === 'backfilled'" class="form-card">
      ...
      <view class="segmented-control" role="tablist" aria-label="完成情况">
        <view
          ...
          @keyup.enter="setBackfilledOutcome('completed')"
          @keyup.space.prevent="setBackfilledOutcome('completed')"
        >
        ...
        <view
          ...
          @keyup.enter="setBackfilledOutcome('cancelled')"
          @keyup.space.prevent="setBackfilledOutcome('cancelled')"
        >
