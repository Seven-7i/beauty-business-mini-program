...
/** 服务项目列表的稳定页面地址。 */
export const BEAUTY_PROJECT_LIST_URL = "/pages-beauty/beauty-project/index";
/** 服务项目统一新增/编辑表单的稳定页面地址。 */
export const BEAUTY_PROJECT_EDITOR_URL = "/pages-beauty/beauty-project-create/index";
...
export function buildBeautyProjectDetailUrl(projectId: string): string {
  return `/pages-beauty/beauty-project-detail/index?projectId=${encodeURIComponent(projectId)}`;
}
