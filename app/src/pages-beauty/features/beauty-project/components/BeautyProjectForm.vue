      ...
      <view class="duration-shortcuts" role="radiogroup" aria-label="常用时长">
        ...
        <view class="duration-shortcuts__options">
          <view
            ...
            @keyup.enter="selectDuration(minutes)"
            @keyup.space.prevent="selectDuration(minutes)"
          >
            {{ minutes }} 分
          </view>
        </view>
...
.duration-shortcuts__option { display: flex; min-width: 0; height: 70rpx; box-sizing: border-box; flex: 1; align-items: center; justify-content: center; border: 2rpx solid #e0dae4; border-radius: 15rpx; background: $surface-card; color: $text-body; font-size: 22rpx; line-height: 1; transition: background-color $press-duration ease, transform $press-duration ease; }
...
.usage-editor__add-button { display: flex; width: 102rpx; height: 76rpx; box-sizing: border-box; flex: none; align-items: center; justify-content: center; border-radius: 15rpx; background: #f2ecfb; color: $accent; font-size: 22rpx; line-height: 1; }
