...
.movement-row__source { width: 100%; min-height: 58rpx; justify-content: space-between; margin: 10rpx 0 0; padding: 8rpx 0 0; border: 0; background: transparent; color: $accent; font-size: 21rpx; text-align: left; }
.movement-row__deleted-source { display: block; margin-top: 12rpx; color: #918a90; font-size: 20rpx; }
.movement-timeline__more { min-height: 72rpx; margin-top: 16rpx; border: 2rpx solid rgba(106, 67, 176, 0.18); border-radius: 16rpx; background: rgba(255, 255, 255, 0.78); color: $accent; font-size: 22rpx; line-height: 1.3; }
