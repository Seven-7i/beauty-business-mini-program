...
function openAdjustment(kind: AdjustInventoryInput["kind"]): void {
  uni.navigateTo({
    url: `/pages-beauty/inventory-adjustment/index?inventoryItemId=${encodeURIComponent(
      props.inventoryItemId,
    )}&kind=${kind}`,
  });
}
...
function openProfileEditor(): void {
  uni.navigateTo({
    url: `/pages-beauty/inventory-profile-edit/index?inventoryItemId=${encodeURIComponent(
      props.inventoryItemId,
    )}`,
  });
}
...
function openSourceAppointment(movement: InventoryMovementV1): void {
  ...
  uni.navigateTo({
    url: `/pages-beauty/appointment/index?appointmentId=${encodeURIComponent(
